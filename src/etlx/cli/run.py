...
from etlx.logging import configure_logging
from etlx.pipeline import Pipeline, PipelineStatus
...
def run(
    ...
    Examples:
        ...
        etlx run pipeline.yml --engine duckdb
        etlx run pipeline.yml --var DATE=2025-01-01 --var ENV=prod
